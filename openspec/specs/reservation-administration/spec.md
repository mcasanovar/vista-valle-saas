...
- **THEN** el detalle muestra la acción para editar `check-in` y `check-out`, y la edición no altera el estado de la reserva
...
- **THEN** el detalle no muestra la acción de editar fechas y una solicitud directa también es rechazada
